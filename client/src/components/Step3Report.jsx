...
const Step3Report = ({ report }) => {
  ...
  const skills = [
    { lebel: "confidence", value: confidence },
    { lebel: "communication", value: communication },
    { lebel: "correctness", value: correctness },
  ]
  ...
  if (finalScore >= 8) {
    ...
    shortTagline = "Excellent clarity and structured responces.";

  } else if (finalScore >= 5) {
    performanceText = "Needs Minor improvement before Interviews.";
    shortTagline = "Good Foundation.refine articulation.";
  } else {
    performanceText = "significant improvement require.";
  ...
  const downloadPDF = async () => {
    ...
    if (finalScore >= 8) {
      ...
      advice =
        "Significant improvement required. Focus on structured thinking, clarity, and confident delivery. Practice answering aloud and review common interview questions.";
    }
  ...
  return (
    <div
      ref={reportRef}
      className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8 '>
      <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        ...
        text-white py-3 rounded-xl shadow-md transition-all 
        duration-300 font-semibold text-sm sm:text-base text-nowrap p-4'>
          Download Pdf
        </button>
      </div>
